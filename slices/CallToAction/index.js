        ...
        >
          <ScrollAnimationWrapper className="relative my-16 h-52 w-full">
            <motion.div variants={scrollAnimation} custom={{ duration: 3 }}>
              <div
                className={`absolute   flex w-full flex-col items-center justify-between rounded-xl ${backgroundColorCssClass} ${textColorCssClass} py-8 px-6 sm:flex-row sm:py-14 sm:px-12 lg:px-16`}
              >
                <div className="mb-6 flex w-10/12 flex-col text-left sm:mb-0 sm:w-7/12 lg:w-5/12">
                  <h5 className="font-dark text-xl leading-relaxed text-white sm:text-2xl lg:text-3xl">
                ...
                <PrismicLink
                  ...
                  className={`ring-primary-300 text-black-600 block  w-full rounded-lg border-2 border-gray-300 bg-gray-100 px-4 py-2 px-12 py-3 font-bold
                  font-bold uppercase shadow hover:cursor-pointer hover:bg-white hover:text-primary focus:outline-none focus:ring sm:w-auto md:px-6`}
                >
                  {slice.primary.texto_boton}
                </PrismicLink>
              </div>
              <div
                className="roudned-lg bg-black-600 absolute top-0 left-0 right-0 mx-auto mt-8 h-60 w-11/12 opacity-5 sm:h-56"
